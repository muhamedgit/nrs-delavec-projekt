...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE sodeluje SET id_delavec = '$idDelavca', id_projekt = '$idProjekt', funkcija = '$funkcija', datum_nastopa = '$datumNastopa' WHERE sodeluje.id_delavec = $idDelavca AND sodeluje.id_projekt = $idProjekt";
    if (mysqli_query($conn, $sql)) {
        echo "<p class='success'>Sprememba je bila uspešna</p>";
    } else {
        echo "<p class='error'>Spremebe ni bilo mogoče izvesti: " . mysqli_error($conn) . "</p>";
    }
}
